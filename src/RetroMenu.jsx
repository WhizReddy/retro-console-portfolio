  ...
  },
  {
    ...
    content: {
      ...
      details: [
        ...
        '⚙️ Backend: Node.js, Python, APIs, Databases',
        '🎨 Design: 3D Modeling, UI/UX, Creative Coding',
        ...
        {!showDetails ? (
          ...
          <div>
            ...
            <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
              <p style={{ color: '#ccc', fontSize: '1.1rem', margin: '0 0 0.5rem 0' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {MENU_ITEMS.map((item, index) => (
                <div
                  ...
                  style={{
                    padding: '1.5rem 2rem',
                    border: selectedIndex === index ? '2px solid #0f0' : '2px solid #333',
                    borderRadius: '10px',
                ...
                >
                  {selectedIndex === index && '▶ '}{item.title}{selectedIndex === index && ' ◀'}
                </div>
              ))}
            </div>
          </div>
